...
public class GenLayerZoom extends GenLayerZoocraftia
{
    public GenLayerZoom(long par1, GenLayerZoocraftia par3GenLayer)
    {
        super(par1);
    ...
    public static GenLayerZoocraftia func_75915_a(long par0, GenLayerZoocraftia par2GenLayer, int par3)
    {
        Object var4 = par2GenLayer;

        for (int var5 = 0; var5 < par3; ++var5)
        {
            var4 = new GenLayerZoom(par0 + (long)var5, (GenLayerZoocraftia)var4);
        }

        return (GenLayerZoocraftia)var4;
    }
}
