...
public class GenLayerRiverMix extends GenLayerZoocraftia
{
    private GenLayerZoocraftia biomePatternGeneratorChain;
    private GenLayerZoocraftia riverPatternGeneratorChain;

    public GenLayerRiverMix(long par1, GenLayerZoocraftia par3GenLayer, GenLayerZoocraftia par4GenLayer)
    {
        super(par1);
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        {
            if (var5[var8] == BiomeGenZoocraftia.ocean.biomeID)
            {
                var7[var8] = var5[var8];
            }
            else if (var6[var8] >= 0)
