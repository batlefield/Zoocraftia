...
import net.zoocraftia.dimension.biomes.BiomeGenZoocraftia;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class ZoocraftiaChunkManager extends WorldChunkManager
{
    private GenLayerZoocraftia genBiomes;

    /** A GenLayer containing the indices into BiomeGenBase.biomeList[] */
    private GenLayerZoocraftia biomeIndexLayer;
    ...
    protected ZoocraftiaChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        this.biomesToSpawnIn.add(BiomeGenZoocraftia.mesa);
        this.biomesToSpawnIn.add(BiomeGenZoocraftia.savannah);
    }

    public ZoocraftiaChunkManager(long par1, WorldType par3WorldType)
    {
        this();
        GenLayerZoocraftia[] var4 = GenLayerZoocraftia.initializeAllBiomeGenerators(par1);
        this.genBiomes = var4[0];
        this.biomeIndexLayer = var4[1];
    }

    public ZoocraftiaChunkManager(World par1World)
    {
    ...
    public ChunkPosition findBiomePosition(int par1, int par2, int par3, List par4List, Random par5Random)
    {
        ...
        for (int var15 = 0; var15 < var12.length; ++var15)
        {
            ...
            if(var15 < 0 || var12[var15] < 0)
            {
	            System.out.println(var15);
	            System.out.println(var12[var15]);
            }
