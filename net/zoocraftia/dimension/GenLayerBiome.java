...
public class GenLayerBiome extends GenLayerZoocraftia
{
    /** this sets all the biomes that are allowed to appear in the overworld */
    private BiomeGenBase[] allowedBiomes;

    public GenLayerBiome(long par1, GenLayerZoocraftia par3GenLayer)
    {
        super(par1);
        this.allowedBiomes = new BiomeGenBase[]{BiomeGenZoocraftia.mesa, BiomeGenZoocraftia.ocean, BiomeGenZoocraftia.savannah};
