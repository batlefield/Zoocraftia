...
public class ChunkProviderZoocraftia implements IChunkProvider
{
    ...
    public ChunkProviderZoocraftia(World par1World, long par2, boolean par4)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        if(!(var6 instanceof BiomeGenZoocraftia))
        {
        	return;
        }
        ...
        ((BiomeGenZoocraftia)var6).zoocraftiaDecorator.decorate(this.worldObj, this.rand, var4, var5);
