...
public class GenLayerShore extends GenLayerZoocraftia
{
    public GenLayerShore(long par1, GenLayerZoocraftia par3GenLayer)
    {
        super(par1);
        ...
        for (int var7 = 0; var7 < par4; ++var7)
        {
            for (int var8 = 0; var8 < par3; ++var8)
            {
                ...
                if (var9 == BiomeGenBase.mushroomIsland.biomeID)
                {
                    ...
                    if (var10 != BiomeGenZoocraftia.ocean.biomeID && var11 != BiomeGenZoocraftia.ocean.biomeID && var12 != BiomeGenZoocraftia.ocean.biomeID && var13 != BiomeGenZoocraftia.ocean.biomeID)
                    {
                ...
                else if (var9 != BiomeGenZoocraftia.ocean.biomeID && var9 != BiomeGenBase.river.biomeID && var9 != BiomeGenBase.swampland.biomeID && var9 != BiomeGenBase.extremeHills.biomeID)
                {
                    var10 = var5[var8 + 1 + (var7 + 1 - 1) * (par3 + 2)];
                    var11 = var5[var8 + 1 + 1 + (var7 + 1) * (par3 + 2)];
                    var12 = var5[var8 + 1 - 1 + (var7 + 1) * (par3 + 2)];
