...
public class BlockPortal extends BlockBreakable
{
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
    	...
    	if(par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null && par5Entity instanceof EntityPlayerMP)
    	{
    		...
    		{
    			player.timeUntilPortal = 500;
    		}else if(player.dimension != ZoocraftiaDimensionMain.dimensionID)
    		{
    			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, ZoocraftiaDimensionMain.dimensionID, new ZoocraftiaTeleporter(player.mcServer.worldServerForDimension(ZoocraftiaDimensionMain.dimensionID)));
    			player.addExperience(0);
    		}else{
    			player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new ZoocraftiaTeleporter(player.mcServer.worldServerForDimension(ZoocraftiaDimensionMain.dimensionID)));
    			player.addExperience(0);
    		}
