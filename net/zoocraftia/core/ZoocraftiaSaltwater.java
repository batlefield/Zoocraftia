...
public class ZoocraftiaSaltwater extends Block
{


    protected ZoocraftiaSaltwater(int i,  Material material)
    {
        super(i, material);
        float f = 0.0F;
        float f1 = 0.0F;
    ...
    {
        Vec3 vec3d1 = getFlowVector(world, i, j, k);
    ...
    public void randomDisplayTick(World world, int i, int j, int k, Random random)
    {
        if(blockMaterial == Material.water)
        {
            ...
            for(int i1 = 0; i1 < 0; i1++)
            {
                ...
                if(world.getBlockMaterial(l1, j, i2) != Material.air || !world.getBlockMaterial(l1, j - 1, i2).isSolid() && !world.getBlockMaterial(l1, j - 1, i2).isLiquid())
                {
                    continue;
                }
                float f = 0.0625F;
    ...
    public static double func_293_a(IBlockAccess iblockaccess, int i, int j, int k, Material material)
    {
        ...
        {
            vec3d = ((ZoocraftiaSaltwater)Block.waterMoving).getFlowVector(iblockaccess, i, j, k);
        }
        if(material == Material.lava)
        {
            vec3d = ((ZoocraftiaSaltwater)Block.lavaMoving).getFlowVector(iblockaccess, i, j, k);
        }
	...
	public String getTextureFile() {
		return "/zoocraftia/core/textures/water.png";
	}
}
