...
public class DartEntity extends Entity implements IProjectile
{
    ...
    public DartEntity(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public DartEntity(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public DartEntity(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    {
                        var22 = new EntityDamageSourceIndirect("dart", this, this).setProjectile();
                    }
                    else
                    {
                        var22 = new EntityDamageSourceIndirect("dart", this, this.shootingEntity).setProjectile();
                        ZoocraftiaMain.proxy.TAGGED_MANAGER.addEntity((EntityPlayer)shootingEntity, var4);
                    }
                    ...
                    if (var4.entityHit.attackEntityFrom(var22, var24))
                    {
                        if (var4.entityHit instanceof EntityLiving)
                        {
                            ...
                            {
                                EntityLiving var23 = (EntityLiving)var4.entityHit;
