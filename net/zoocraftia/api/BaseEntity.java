...
import net.zoocraftia.core.network.EntityGuiPacket;
...
public abstract class BaseEntity extends EntityLiving implements IEntityAdditionalSpawnData{
    ...
    {
		EntityGuiPacket.openGUI(player, ageTicks, getSex(), hunger, health, messages, getMaxHealth(), getMaxHunger(), (String)EntityList.classToStringMapping.get(this.getClass()));
		messages.clear();
		return true;
    }
	...
	//tons of getter and setter methods for all of the data that needs to be sent to server
