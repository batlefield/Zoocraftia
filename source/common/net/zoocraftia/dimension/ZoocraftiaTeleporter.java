            ...
            for (int j1 = -2; j1 <= 2; j1++)
            {
                for (int k1 = -2; k1 <= 2; k1++)
                {
                    for (int l1 = -1; l1 < 3; l1++)
                    {
                        ...
                        int k2 = (k + k1 * i1) - j1 * l;
                        boolean flag = l1 < 0;
                        world.setBlockWithNotify(i2, j2, k2, flag ? ZoocraftiaBlocks.brownstone.blockID : 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(World world, Entity entity)
    {
        ...
        for (int j1 = l - c; j1 <= l + c; j1++)
        {
            ...
            for (int j2 = i1 - c; j2 <= i1 + c; j2++)
            {
                ...
                {
                    if (world.getBlockId(j1, k2, j2) != net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID)
                    {
                        continue;
                    }
                    for (; world.getBlockId(j1, k2 - 1, j2) == net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID; k2--) { }
        ...
        if (d >= 0.0D)
        {
            ...
            if (world.getBlockId(k1 - 1, l1, i2) == net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID)
            {
                d2 -= 0.5D;
            }
            if (world.getBlockId(k1 + 1, l1, i2) == net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID)
            ...
            if (world.getBlockId(k1, l1, i2 - 1) == net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID)
            {
                d6 -= 0.5D;
            }
            if (world.getBlockId(k1, l1, i2 + 1) == net.zoocraftia.dimension.ZoocraftiaBlocks.portal.blockID)
