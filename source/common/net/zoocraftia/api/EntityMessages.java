...
public class EntityMessages {
	...
	public static final EntityMessages[] messages = new EntityMessages[1024];
	...
	public static final EntityMessages lowHealth = new EntityMessages(0, "The entity is low on health! Take some food and feed it to regain health!").setPriority(HIGHEST);
	public static final EntityMessages ok = new EntityMessages(1, "The entity is OK and doesn't require anything");
